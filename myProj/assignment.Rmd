...
if (!require(ProjectTemplate)) install.packages("ProjectTemplate", repos = "https://cloud.r-project.org") #if packages are not installed intalll it first
library(ProjectTemplate)

# Load the full project (this sources the 01-A.R and loads merged_bmi_data)
load.project() 
...
# knitr options for reproducibility and clarity
...
report_data <- get("merged_bmi_data")  # Retrieve the merged dataset 

# Define year range variables dynamically
...
# Filter start and end year data, then calculate the difference
...
# Prepare data for obesity visualization
...
# Prepare data for underweight visualization
